...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("conv_forward_fetch_on_demand_cuda",
        &conv_forward_fetch_on_demand_cuda);
  m.def("conv_forward_fetch_on_demand_no_fusion_cuda",
        &conv_forward_fetch_on_demand_no_fusion_cuda);
  m.def("conv_forward_implicit_gemm_cuda", &conv_forward_implicit_gemm_cuda,
        py::arg("_in_feats"), py::arg("_kernel"), py::arg("_out_in_map"),
        py::arg("num_out_feats"), py::arg("num_out_channels"),
        py::arg("allow_tf32") = false, py::arg("allow_fp16") = true);
  m.def("conv_forward_implicit_gemm_sorted_cuda",
        &conv_forward_implicit_gemm_sorted_cuda, py::arg("_in_feats"),
        py::arg("_kernel"), py::arg("_out_in_map"), py::arg("_reduced_mask"),
        py::arg("_reorder_loc"), py::arg("num_out_feats"),
        py::arg("num_out_channels"), py::arg("allow_tf32") = false,
        py::arg("allow_fp16") = true);
  m.def("conv_backward_wgrad_implicit_gemm_cuda",
        &conv_backward_wgrad_implicit_gemm_cuda, py::arg("_in_feats"),
        py::arg("_kernel"), py::arg("_out_in_map"), py::arg("split_k_iters"),
        py::arg("allow_tf32") = false, py::arg("allow_fp16") = true);
  m.def("conv_backward_wgrad_implicit_gemm_sorted_cuda",
        &conv_backward_wgrad_implicit_gemm_sorted_cuda, py::arg("_in_feats"),
        py::arg("_kernel"), py::arg("_out_in_map"), py::arg("_reduced_mask"),
        py::arg("_reorder_loc"), py::arg("split_k_iters"),
        py::arg("allow_tf32") = false, py::arg("allow_fp16") = true);
  ...
  m.def("exclusive_scan_quantified_wrapper",
        &exclusive_scan_quantified_wrapper);
  ...
  m.def("build_kernel_map_subm_hashmap_int32",
        &build_kernel_map_subm_hashmap_int32);
  m.def("build_kernel_map_downsample_hashmap_int32",
        &build_kernel_map_downsample_hashmap_int32);
